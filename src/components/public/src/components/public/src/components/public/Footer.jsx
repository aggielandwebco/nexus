        ...
        <div className="grid gap-10 md:grid-cols-[1.2fr_1fr] md:items-start">
          <div>
            ...
            <p className="mt-5 max-w-md text-sm leading-6 text-muted-foreground">
              Integris Nexus is a CRM and customer growth platform for
              businesses that need leads, bookings, reviews, analytics, AI
              follow-ups, and billing in one clean dashboard.
            </p>
          </div>
